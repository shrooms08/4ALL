...
@export var bullet_pickup_scenes: Array[PackedScene] = []
...
func spawn_random_bullet_pickup():
	if bullet_pickup_scenes.is_empty():
	...
	var random_pickup_scene = bullet_pickup_scenes[randi() % bullet_pickup_scenes.size()]
